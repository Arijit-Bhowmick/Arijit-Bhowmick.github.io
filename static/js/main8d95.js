...
(() => {
  ...
  n.n = t => {
    ...
    const Uf = new class extends bf {
        ...
        async init() {
          const t = new gc,
            e = [t.loadAsync("/static/texture/grain.webp"), t.loadAsync("/static/texture/blur.webp")],
      ...
      Df = {
        ...
        isTransitioning: !1,
        pagePaths: ["/", "/projects/", "/info/", "/contact/", "/donate/"],
        currentPath: null,
        init() {
          this.$page = document.getElementById("Page"), this.pages = {
            ...
            "/donate/": document.querySelector('[data-page="donate"]')
          };
      ...
      document.addEventListener("DOMContentLoaded", () => {
        ...
        // Check if the entryview query parameter is present and has the value "False"
        if (urlParams.has("entryview") && urlParams.get("entryview") === "0") {
            // The entryview parameter is present with the value "False"
            // You can choose to remove the EnterView div or take any other action here
            const enterViewDiv = document.getElementById("EnterView");
            if (enterViewDiv) {
                enterViewDiv.remove(); // Remove the EnterView div
            }
        }
